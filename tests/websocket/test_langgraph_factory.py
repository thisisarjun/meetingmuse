...
from server.langgraph.langgraph_factory import LangGraphSingletonFactory
...
class TestLangGraphSingletonFactory:
    ...
    @patch('meetingmuse_server.langgraph.langgraph_factory.LangGraphSingletonFactory._create_conversation_graph')
