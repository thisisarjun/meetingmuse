...
class TestConnectionManager:
    ...
    def test_disconnect_existing_client(self, connection_manager):
        ...
        connection_manager.connection_metadata[client_id] = {"connected_at": datetime.now().isoformat(), "message_count": 5}
    ...
    async def test_send_error_message(self, connection_manager, mock_websocket):
        ...
        result = await connection_manager.send_error_message(client_id, error_code, error_message, retry_suggested=False)
    ...
    def test_increment_message_count(self, connection_manager):
        ...
        connection_manager.connection_metadata[client_id] = {"connected_at": datetime.now().isoformat(), "message_count": 0}
