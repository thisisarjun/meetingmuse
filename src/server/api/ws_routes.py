...
def create_app() -> FastAPI:
    ...
    @app.get("/health/clients")  # type: ignore
    ...
    @app.websocket("/ws/{client_id}")  # type: ignore
    async def websocket_endpoint(websocket: WebSocket, client_id: str) -> None:
        ...
        try:
            while True:
                ...
                logger.info(
                    f"Received message from {client_id}: {message_text[:100]}..."
                )
                ...
                try:
                    ...
                    interrupt_info = await message_processor.handle_interrupts(
                        client_id
                    )
                    ...
                    if interrupt_info and interrupt_info.get("waiting_for_input"):
                        ...
                        interrupt_notification = (
                            await streaming_handler.create_interrupt_notification(
    ...
    @app.post("/admin/broadcast")  # type: ignore
    ...
    @app.get("/admin/connections")  # type: ignore
