...
class ErrorMessages:
    ...
    INVALID_MESSAGE_FORMAT = "Message format is invalid. Please check the message structure."    
    INTERNAL_SERVER_ERROR = "An internal error occurred. Please try reconnecting."
    LLM_PROCESSING_ERROR = "I'm having trouble processing your request. Please try again."
