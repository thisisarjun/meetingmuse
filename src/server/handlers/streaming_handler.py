...
class StreamingHandler:
    ...
    async def _process_chunk(self, chunk: Dict[str, Any], client_id: str) -> Optional[Dict[str, Any]]:
        """
    ...
    async def send_processing_notification(self, step: str, client_id: str) -> Dict[str, Any]:
        """
    ...
    async def create_interrupt_notification(
        ...
        return {
            ...
            "content": interrupt_info.get("prompt", "Please provide additional information"),
